...
class Experiment:
    ...
    def run_expr(self):
        ...
        while i < self.num_iterations:
            ...
            trajectories = self.run_policy(self.episodes)
            ...
            avg_rewards = np.sum(np.concatenate([t['rewards'] for t in trajectories])) / len(trajectories)
        ...
        self.critic.save(OUTPATH) # added
